...
lr=1e-5
epoch=5
tr_data=./content/drive/MyDrive/Rana_Draytonii/Rana7/data/train_data.json # replace with your training data path
te_data=./content/drive/MyDrive/Rana_Draytonii/Rana7/data/val_data.json # replace with your evaluation data path
freqm=48
timem=200
mixup=0.5
fstride=10
...
--label-csv ./content/drive/MyDrive/Rana_Draytonii/Rana7/data/labels.csv --n_class 2 \
